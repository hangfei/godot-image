...
echo ""
echo "🎮 NEW: Generate GLB assets for game development:"
echo "  pip install trimesh numpy networkx"
echo "  python3 generate_assets.py --type pack"
echo "  See ASSET_GENERATOR_README.md for full documentation" 